...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      description: "Optional. Paste a Spline scene's public viewer URL (from Spline's Share/Export panel, e.g. https://my.spline.design/xxxxxxxx/) to show that 3D scene as an animated background behind the Hero section. It's shown non-interactively, purely as a background. Leave empty to keep the default background.",
      type: "url",
      group: "hero",
    }),
